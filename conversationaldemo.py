...
def get_llm():
    ...
    return ChatGroq(model="llama-3.3-70b-versatile", api_key=SecretStr(groq_api_key))
...
with st.sidebar:
    ...
    source_type = st.radio("Choose data source", ["Web URL", "PDF"])
...
if prompt:
    if "vector_db" not in st.session_state:
        ...
        rag_chain = create_retrieval_chain(
            create_history_aware_retriever(llm, retriever, context_aware_prompt),
